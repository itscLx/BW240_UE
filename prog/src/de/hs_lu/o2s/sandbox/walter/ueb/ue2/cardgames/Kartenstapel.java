package de.hs_lu.o2s.sandbox.walter.ueb.ue2.cardgames;

import de.hs_lu.o2s.sandbox.walter.ueb.ue2.cardgames.Kartenspiel;
import de.hs_lu.o2s.sandbox.walter.ueb.ue2.cardgames.Spielkarte;
